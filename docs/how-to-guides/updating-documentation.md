...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.eaglepass.io](https://homelab.eaglepass.io).
...
It's running on my other cluster in the [brimdor/horus](https://github.com/brimdor/horus) project
(so if the homelab goes down everyone can still read the documentation).

<!-- TODO -->
<!-- This website is running in both my homelab cluster and on my other cluster in the [brimdor/horus](https://github.com/brimdor/horus) project (both in `apps/homelab-docs`), -->
...
<!-- - Find the TXT record for `homelab.eaglepass.io` and switch the `ownerID` between `homelab` and `horus` -->
